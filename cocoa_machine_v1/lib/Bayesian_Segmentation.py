...
from lib.function import read_yaml
...
class Bayesian_Segmentation():
    def __init__(self, n_features=6, 
        ...
        self.segmentation_parameter = dict()
    ...
    def segment(self, image_arr, k, threshold=0.9, filter=False):
    ...
    def load_parameter(self, path=None):
        ...
        data = read_yaml(path)
        self.segmentation_parameter = data['model_segment']
...
def load_bayesian_obj(filepath:str):
